package widgets.DANE.Resultados
{
...
public class SwipeTool extends BaseTool
{
	...
	[Embed(source="assets/images/swipe-left.png")]
	private var _swipeLeftIcon:Class;
	
	[Embed(source="assets/images/swipe-right.png")]
	private var _swipeRightIcon:Class;
	
	[Embed(source="assets/images/swipe-up.png")]
	private var _swipeUpIcon:Class;
	
	[Embed(source="assets/images/swipe-down.png")]
	private var _swipeDownIcon:Class;
	
	[Embed(source="assets/images/swipe-down-right.png")]
	private var _swipeDownRightIcon:Class;
	
	[Embed(source="assets/images/swipe-down-left.png")]
	private var _swipeDownLeftIcon:Class;
	
	[Embed(source="assets/images/swipe-up-right.png")]
	private var _swipeUpRightIcon:Class;
	
	[Embed(source="assets/images/swipe-up-left.png")]
	private var _swipeUpLeftIcon:Class;
	
	[Embed(source="assets/images/swipe-horizontal.png")]
	private var _swipeHorizontalIcon:Class;
	
	[Embed(source="assets/images/swipe-vertical.png")]
	private var _swipeVerticalIcon:Class;
	
	[Embed(source="assets/images/swipe-diagonal-tl.png")]
	private var _swipeDiagonalTLIcon:Class;
	
	[Embed(source="assets/images/swipe-diagonal-tr.png")]
	...
	private function unapplyMask():void {
		...
		if (_mask) {
			if (map) {
				// Remove the mask from the display list
				try {
		...
		if (cursor) {
			if (cursor !== _currentCursor) {
				...
				switch (_currentRegion) {
					...
					{
						_cursorID = CursorManager.setCursor(cursor,2,-11,-11);
						break;
					}
					case TOP_LEFT: case BOTTOM_RIGHT: case TOP_RIGHT: case BOTTOM_LEFT:
					{
						_cursorID = CursorManager.setCursor(cursor,2,-8,-8);
						break;
					}
				}
			}
