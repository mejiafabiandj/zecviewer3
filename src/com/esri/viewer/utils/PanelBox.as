...
public class PanelBox extends DividedBox
{
	...
	//Fabian
    private var expandPanelTooltip:String = LocalizationUtil.getDefaultString("expandPanelTooltip") || "Click to expand the panel";
    private var collapsePanelTooltip:String = LocalizationUtil.getDefaultString("collapsePanelTooltip") ||"Click to collapse the panel";
