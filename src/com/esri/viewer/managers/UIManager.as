...
//        }
    ...
    private function setViewerStyle():void
    {
        ...
        */
		...
		/**Fabian: border container**/
		//Style s|BorderContainer
		var cssStyleDeclarationSBorderContainer:CSSStyleDeclaration = topLevelStyleManager.getStyleDeclaration("spark.components.BorderContainer");
		if (numberOfStyleColors > 4)
		{
			cssStyleDeclarationSBorderContainer.setStyle("backgroundColor", backgroundColor);
		}
		cssStyleDeclarationSBorderContainer.setStyle("backgroundAlpha", styleAlpha);
		topLevelStyleManager.setStyleDeclaration("spark.components.BorderContainer", cssStyleDeclarationSBorderContainer, false);
		
		/**Fabian: border container**/
		//Style AdvancedDataGrid
		var cssStyleDeclarationAdvancedDataGrid:CSSStyleDeclaration = new CSSStyleDeclaration();
		if (numberOfStyleColors > 4)
		{
			cssStyleDeclarationAdvancedDataGrid.setStyle("alternatingItemColors", [ backgroundColor, backgroundColor ]);
			cssStyleDeclarationAdvancedDataGrid.setStyle("contentBackgroundColor", backgroundColor);
			cssStyleDeclarationAdvancedDataGrid.setStyle("color", textColor);
		}
